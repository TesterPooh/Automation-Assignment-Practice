...
public class LoginTest  extends TestBase{
	...
	@Test(description = "Verifies valid user is able to login into application", groups = { "e2e",
	...
	@Test(description = "Verifies valid user is able to login into application", groups = { "e2e",
			"sanity" }, dataProviderClass = com.ui.dataproviders.LoginDataProvider.class, dataProvider = "LoginTestxlsDataProvider", retryAnalyzer = com.ui.listeners.MyRetryAnalyzer.class)
	public void loginxlstest(User user) {
		assertEquals(homePage.gotoLoginPage().doLoginWith(user.getEmailaddress(), user.getPassword()).getUserName(),
				"Pooh nemade");
